...
CREATE TABLE IF NOT EXISTS `projectdb`.`song` (
  ...
  `LYRICS_ID` VARCHAR(10) NOT NULL,
  `MOOD_ID` VARCHAR(4) NOT NULL,
  `topic_TOPIC_ID` VARCHAR(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `projectdb`.`song_has_artist` (
  `song_SONG_ID` VARCHAR(10) NOT NULL,
